                ...
                <div className='grid-2 grid-2-login'>
                    ...
                    <div className='grid-item-login'>
                        <div className='flex-col-center full-width'>
                            <div className='logo-login pad-b-xl'>
                            ...
                            <form className='contact-form pad-b-xl'>
                                ...
                                <div className='contact-form-item'>
                                    <input type='text' className='input input-medium input-text input-border-orange' placeholder='Username'/>
                                </div>
                                <div className='contact-form-item'>
                                ...
                                <div className='contact-form-item'>
                                    <input type='text' className='input input-medium input-text input-border-orange' placeholder='Addresse'/>
                                </div>
                                <div className='contact-form-item'>
                                    <input type='text' className='input input-medium input-text input-border-orange' placeholder='Telephone' pattern="[0-9]{1,10}"/>
                                </div>
