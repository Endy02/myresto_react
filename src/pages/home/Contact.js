                        ...
                        <div className='grid-item'>
                            <div className='flex-col-center full-width'>
                                <form className='contact-form' onSubmit={handleSubmit}>
                                    ...
                                    <div className='contact-form-item'>
                                        <input type='text' className='input input-large input-text input-orange' placeholder='Nom et prénom'/>
                                    </div>
                                    <div className='contact-form-item'>
                                        <input type='email' className='input input-large input-text input-orange' placeholder='Email'/>
                                    </div>
                                    <div className='contact-form-item'>
                                        <textarea rows='5' col="33" className='input input-large input-textarea input-orange' placeholder='Message'/>
                                    </div>
                                    <div className='contact-form-item flex-col-center'>
                                        <button type='submit' className='btn btn-bordered btn-medium btn-current'>Envoyer</button> 
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div className='grid-item'>
                            <div className='flex-full-center full-width'>
                                <div className='img-large'>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 842.947 554.942">
