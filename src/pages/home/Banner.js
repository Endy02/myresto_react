  ...
  return (
      <>
        <div className="hero-section" id="hero-section">
            ...
            <div className="hero-content pad-b-xl">
                <div className="hero-title">
                    <h1 className="white-text home-title pad-b-s">Bienvenue dans un univers culinaire hors du commun.</h1>
                    <p className='white-text regular-text pad-b-l'>Découvrez une large game de burger et de plats prêts a ravir n'importe qu'elle estomac en détresse. Consulter notre carte pour pour d'informations sur les multiple variétés de plats à coupé le souffle.</p>
                    <Link to="/commande" className="btn btn-large btn-bordered btn-current">Passer commande</Link>
                </div>
                <div className='hero-persona'>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 173.008 466.702">
