  ...
  return (
    <>
      <div className='sidebar'>
        <div className='sidebar-logo pad-t-xl'>
          <Link to='/' >
        ...
        <div className='side-menu'>
          <ul className='side-nav'>
            <li className='side-nav-item'>
              <NavLink to='/dashboard' activeclassname="active" className='side-nav-link'>
                <p className='large-text bold-text'>Dashboard</p>
              </NavLink>
            </li>
            <li className='side-nav-item'>
              <NavLink to='/administrateur/commandes' activeclassname="active" className='side-nav-link'>
                <p className='large-text bold-text'>Commandes</p>
              </NavLink>
            </li>
            <li className='side-nav-item'>
              <NavLink to='/administrateur/clients' activeclassname="active" className='side-nav-link'>
                <p className='large-text bold-text'>Clients</p>
              </NavLink>
            </li>
          </ul>
        </div>
