              ...
              <svg id="Layer_2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 213.75 189.66">
                  <g id="Layer_1-2">
                      <g id="Group_3">
                          ...
                          <g id="MYRESTO" className="footer-cls-1">
                              <g className="footer-cls-1">
                                  <path className="footer-cls-2"
                          ...
                          <g id="BAR_RESTAURANT" className="footer-cls-1">
                              <g className="footer-cls-1">
                                  <path className="footer-cls-2"
                                  ...
                                  <path className="footer-cls-2" d="m111.6,132.53h-3.38v9.16h-.83v-9.16h-3.37v-.7h7.58v.7Z" />
                                  <path className="footer-cls-2"
                                  ...
                                  <path className="footer-cls-2" d="m174.4,132.53h-3.38v9.16h-.83v-9.16h-3.37v-.7h7.58v.7Z" />
                              </g>
                          </g>
                      </g>
                  </g>
        ...
        <div className='footer-content'>
          <div className='footer-content-items'>
            <ul className='footer-link-list'>
              <li><Link className='footer-link' to="/statistics"><p className='medium-text bold-text'>Menu</p></Link></li>
              <li><Link className='footer-link' to="/simulator"><p className='medium-text bold-text'>Contact</p></Link></li>
              <li><Link className='footer-link' to="/simulator"><p className='medium-text bold-text'>Mention Légales</p></Link></li>
              <li><Link className='footer-link' to="/simulator"><p className='medium-text bold-text'>Politique de confidentialité</p></Link></li>
            </ul>
          </div>
        </div>
        <div className='footer-footer'>
          <div className='footer-footer-wrapper'>
            <div className='footer-copy'>
              <p className='medium-text regular-text white-text'>&copy; {(new Date().getFullYear())} - MyResto</p>
            </div>
            <div className='footer-builder'>
              <p className='small-text light-text white-text'>Made by fujyn</p>
            </div>
          </div>
        </div>
      </div>
